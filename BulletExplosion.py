...
class Bullet_Explosion(Sprite):
	# Bulltets from our spaceship

	def __init__(self, screen, bullet):
		super(Bullet_Explosion,self).__init__()
		self.screen = screen
		...
		self.rect.centery = bullet.rect.centery - 2*bullet.speed - random.randint(0,bullet.speed)
	...
	def draw_bullet_explosion(self):
